...
import { FaUser, FaCreditCard, FaLock, FaBell, FaMoneyBillWave, FaMobileAlt, FaPaypal, FaAtom, FaTrash, FaEye, FaEyeSlash } from 'react-icons/fa';
                        ...
                        {activeContent === 'addCoupon' && !showAddCouponForm && (
                            <div id="addCoupon" className="content-section">
                                ...
                                <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'center' }}>
                                    <Button onClick={() => setShowAddCouponForm(true)}>Add Coupon</Button>
                                </div>
                            </div>
                        )}
